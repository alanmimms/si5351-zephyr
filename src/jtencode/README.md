JT65/JT9/JT4/FT8/WSPR/FSQ Encoder Library
=========================================

NOTE: This [was originally for
Arduino](https://github.com/etherkit/JTEncode), but I wanted to use a
_real_ build system, so I (Alan/WB7NAB) made it an Espressif IDF
Component for my ESP32C3 based WSPR beacon project. The rest of this
README.md is left intact for posterity. You can find the examples
referenced below in the original GitHub respository.
